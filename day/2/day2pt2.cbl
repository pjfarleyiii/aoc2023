      ...
      *-------------
       ...
       01  GAME-VARIABLES.
           ...
           05  GAMEPOW           PIC  9(8) BINARY VALUE 0.
       ...
       01  DRAW-VARIABLES.
           ...
           05  MAXVALRED         PIC 99 VALUE ZEROES.
           05  MAXVALBLUE        PIC 99 VALUE ZEROES.
           05  MAXVALGREEN       PIC 99 VALUE ZEROES.
...
DEBUG>D            DISPLAY "LINE " LINECTR " LEN=" LINELEN
      ...
      D            END-PERFORM
               ...
               MOVE ZEROES TO MAXVALRED MAXVALGREEN MAXVALBLUE
               PERFORM VARYING SS1 FROM 1 BY 1 UNTIL SS1 > DRAWSMAX
                   ...
                   PERFORM VARYING SS2 FROM 1 BY 1
                       ...
                       EVALUATE TRUE ALSO TRUE
                           WHEN REVLRED   (SS1, SS2) ALSO
                                COLORVAL  (SS1, SS2) > MAXVALRED
                                MOVE COLORVAL  (SS1, SS2) TO MAXVALRED
                           WHEN REVLGREEN (SS1, SS2) ALSO
                                COLORVAL  (SS1, SS2) > MAXVALGREEN
                                MOVE COLORVAL  (SS1, SS2) TO MAXVALGREEN
                           WHEN REVLBLUE  (SS1, SS2) ALSO
                                COLORVAL  (SS1, SS2) > MAXVALBLUE
                                MOVE COLORVAL  (SS1, SS2) TO MAXVALBLUE
                       END-EVALUATE
                   END-PERFORM
               END-PERFORM
      D        DISPLAY "GAME " GAMENO "MAX RGB="
      D            MAXVALRED "," MAXVALGREEN "," MAXVALBLUE
               COMPUTE GAMEPOW = GAMEPOW +
