...
DEBUG>D            DISPLAY "LINE " LINECTR " LEN=" LINELEN
      ...
      *            SEPARATE TABLE ELEMENTS INTO CORRECT TABLE
...
DEBUG>D                    DISPLAY "LINE " LINECTR " LEN=" LINELEN
               ...
               END-IF
           END-PERFORM
      D    DISPLAY "TIMES: " TIMEMAX " ENTRIES:"
      D    PERFORM VARYING SS1 FROM 1 BY 1 UNTIL SS1 > TIMEMAX
      D        DISPLAY "[" SS1 "]TIMEBEG=" TIMEBEG (SS1)
      D            " TIMEEND=" TIMEEND (SS1)
      D    END-PERFORM
      D    DISPLAY "DISTANCES: " DISTMAX " ENTRIES:"
      D    PERFORM VARYING SS1 FROM 1 BY 1 UNTIL SS1 > DISTMAX
      D        DISPLAY "[" SS1 "]DISTBEG=" DISTBEG (SS1)
      D            " DISTEND=" DISTEND (SS1)
      D    END-PERFORM
           DISPLAY " ".
