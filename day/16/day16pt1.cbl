...
DEBUG>*                ", LINE='" LINEINPUT ( 1 : LINELEN) "'"
      ...
      *    INITIALIZE FOR FIRST BEAM MOVE (RIGHT FROM (1,1))
           MOVE +1 TO START-X START-Y START-DX
           MOVE +0 TO START-DY
           PERFORM 300-GET-ENERGIZED
      *    COUNT ENERGIZED TILES FOR PART 1
           MOVE +0 TO ENERGIZED
      ...
      D            NEW-MAP (NEWMNDX) (1 : NEWMLEN) "'"
           END-PERFORM
           DISPLAY "PART 1 - ENERGIZED:" ENERGIZED
           .
      ...
      *        MOVE THE BEAM THROUGH THE MAP
      ...
      D        PERFORM 250-SHOW-NEW
       ...
       900-WRAP-UP.
           CLOSE INPUT-FILE.
      *    DISPLAY "WEIGHT=" MIRO-WEIGHT
           CONTINUE.

       END PROGRAM DAY16PT1.
