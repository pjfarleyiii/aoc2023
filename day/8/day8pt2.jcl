//AOC7PF82 JOB CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),
//         NOTIFY=&SYSUID,REGION=0M  ,RESTART=RUN
/*JOBPARM LINES=00009
//*--------------------------------------------------------------
//JCLLIB   JCLLIB ORDER=(IGY.V6R4M0.SIGYPROC)
// EXPORT SYMLIST=*
// SET PROGRAM=DAY8PT2    <=== YOUR PROGRAM NAME
//*
//CL       EXEC IGYWCL,
//             PARM.COBOL='NOSEQ,MAP,DS(S),AR(E)',
//             PARM.LKED='LIST,MAP',
...
//AOCINPUT DD  PATH='/home/&SYSUID/day/8/input',   input',  intest1',
//             PATHDISP=(KEEP,KEEP),
//             PATHOPTS=(ORDONLY),
//             RECFM=V,LRECL=32760
