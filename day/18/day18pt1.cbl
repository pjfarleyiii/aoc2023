      ...
      *-------------
       ...
       01 WORK-AREAS.
          ...
          05  AREA-TOTAL                 PIC S9(09) COMP-5 VALUE +0.
          05  PERIMETER                  PIC S9(09) COMP-5 VALUE +0.
          05  START-DATA.
          ...
          05  MOVE-CNT-NUM               PIC S9(04) COMP-5 VALUE +0.
       ...
       01 VERTICES-AREA.
          ...
          05  VERTICES-DATA.
              10  FILLER                 OCCURS 1024 TIMES
                                         INDEXED BY VERTNDX.
                  15  VERT-X             PIC S9(04) COMP-5 VALUE +0.
                  15  VERT-Y             PIC S9(04) COMP-5 VALUE +0.
...
DEBUG>*                ", LINE='" LINEINPUT ( 1 : LINELEN) "'"
      ...
      *        SPLIT APART INPUT PARAMETERS
               UNSTRING LINEINPUT (1 : LINELEN)
                   DELIMITED BY SPACE OR "(" OR ")" OR "#" INTO
                   MOVE-CHAR
                   MOVE-COUNT
                   MOVE-DELIM
                   MOVE-DELIM
               ...
               SEARCH DIRECTN-TABLE
                   ...
                   WHEN DIRC-CHAR (DIRCNDX) = MOVE-CHAR
                       MOVE DIRC-X (DIRCNDX) TO MOVE-DX
                       MOVE DIRC-Y (DIRCNDX) TO MOVE-DY
                       SET DIRCSUB TO DIRCNDX
               END-SEARCH
               COMPUTE MOVE-CNT-NUM = FUNCTION NUMVAL (MOVE-COUNT)
               MOVE FUNCTION HEX-TO-CHAR (MOVE-COLOR) TO MOVE-CLR-BYTES
               COMPUTE MOVE-CLR-LAST = FUNCTION MOD (MOVE-CLR-NUM, 4)
      ...
      *    NOW COMPUTE AREA FROM VERTICES
      ...
      D    DISPLAY "PERIMETER=" PERIMETER
           DISPLAY "PART 1=" AREA-TOTAL
           CONTINUE.

       END PROGRAM DAY18PT1.
